  ...
  const themes = {
    animals: {
      ...
      images: [
        ...
        "public/images/animals/elephant.webp",
        "public/images/animals/fox.png",
        "public/images/animals/hamster.png",
        "public/images/animals/lion.webp",
        "public/images/animals/monkey.webp",
        "public/images/animals/panda.webp",
    ...
    space: {
      ...
      images: [
        "public/images/space/alien.webp",
        "public/images/space/astronaut.webp",
        "public/images/space/galaxy.webp",
        "public/images/space/moon.png",
        "public/images/space/planet.png",
        "public/images/space/rocket.png",
        "public/images/space/star.png",
        "public/images/space/sun.png",
      ],
    },
    fantasy: {
      ...
      images: [
        "public/images/fantasy/castle.png",
        "public/images/fantasy/crown.png",
        "public/images/fantasy/dragon.webp",
        "public/images/fantasy/griffin.webp",
        "public/images/fantasy/potion.png",
        "public/images/fantasy/sword.png",
        "public/images/fantasy/unicorn.png",
        "public/images/fantasy/wand.png",
      ],
    },
  };

  const sounds = {
    flip: new Audio("public/sounds/flip.mp3"),
    match: new Audio("public/sounds/match.wav"),
    win: new Audio("public/sounds/win.mp3"),
    hint: new Audio("public/sounds/hint.wav"),
    again: new Audio("public/sounds/again.wav"),
    themeAnimals: new Audio("public/sounds/theme-animals.wav"),
    themeSpace: new Audio("public/sounds/theme-space.wav"),
    themeFantasy: new Audio("public/sounds/theme-fantasy.wav"),
  };
